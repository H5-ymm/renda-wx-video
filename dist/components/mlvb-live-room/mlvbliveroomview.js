var liveroom = require('../../lib/mlvbliveroomcore.js');
const app = getApp()
// 没使用到
var errorCode = [
    { '-9001': '创建房间失败' },
...
Component({
    ...
    properties: {
        ...
        destroyRoom: {type: Boolean, value: false,
            observer: function (newVal, oldVal) {
              console.log(newVal)
              this.data.destroy = newVal
              this.stop()
            }
        }
    },
    ...
    methods: {
            ...
            if (self.data.isCaster == false) {     //观众
                ...
                liveroom.getPushURL({
                    success: function (ret) {
                        ...
                        console.log(self.data.mainPusherInfo)
                        ...
                        self.setData({
                            ...
                            //开始推流)
                            console.log(self.data.pusherContext)
        ...
        exit: function () {
            ...
            liveroom.exitRoom({overBtnShow: this.data.destroy});
        },
        ...
        linkJionPusher() {
            ...
            var self = this;
            console.log(self.data.linkPusherInfo.url)
            console.log('的')
        ...
        onMainPush(ret) {
            ...
            switch (ret.detail.code) {
                ...
                case 1002: {
                    ...
                    console.log(self.data.isInRoom)
                    console.log('推流飒飒飒飒')
    ...
    attached: function () {
        ...
        console.log(liveroom.getAccountInfo())
